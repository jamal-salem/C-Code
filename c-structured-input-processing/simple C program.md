## A simple C program that reads structured input, calculates sum and average, and demonstrates basic data parsing using structs.
...
# C Structured Input Processing

## 📌 Overview

This project is part of my learning journey in C programming and computational thinking.

The program reads three integer values from user input, processes them using a structured data type (`struct`), and calculates:
...
The user enters three integers separated by spaces:
...
* Build a foundation for more advanced system-level programming
...
Jamal Salem
Computer Engineer | Future System-Level Developer
